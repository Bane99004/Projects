...
def train():
    ...
    training_set = train_datagen.flow_from_directory(
        'Dataset_exter/training_set', target_size=(150, 150), batch_size=32, class_mode='binary')

    test_datagen = ImageDataGenerator(rescale=1./255)
    test_set = test_datagen.flow_from_directory(
        'Dataset_exter/test_set', target_size=(150, 150), batch_size=32, class_mode='binary')
